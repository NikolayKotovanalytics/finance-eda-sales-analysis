...
-- SQL EDA Phase 2: Data safety checks
---------------------------------------------------------------------------

-- TASK 1 Check if any transaction was performed after expiration of a bank card. Show client and card ids for these transactions 
